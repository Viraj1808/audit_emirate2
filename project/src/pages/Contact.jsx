            ...
            >
              <form className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full bg-gradient-to-r from-primary to-accent text-white py-4 rounded-lg font-semibold transition-all duration-300 transform hover:shadow-xl"
                >
                  Send Message
                </motion.button>
              </form>
